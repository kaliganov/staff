...
function kama_create_csv_file( $create_data, $file = '', $col_delimiter = ';', $row_delimiter = "\r\n" ){
  ...
  if( $file != '' ){
    ...
    $CSV_str = mb_convert_encoding ($CSV_str,'cp1251', 'UTF-8');
...
$reportFileName = "report_$today_date.csv";
$total_result = kama_create_csv_file($total_array, "//Atlant.mega-f.ru/o/HR/Employee_report/$reportFileName");
...
$mail = 'murzo@tfnopt.ru, karaseva@tfnopt.ru, kaliganov@softworks.ru';
